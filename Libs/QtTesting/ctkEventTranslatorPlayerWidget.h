...
//-----------------------------------------------------------------------------
class CTK_QTTESTING_EXPORT ctkEventTranslatorPlayerWidget: public QMainWindow
{
  Q_OBJECT
public:
...
//  void setXMLFileName(const QString& newFileName);
...
private:
  ...
  Ui::ctkEventTranslatorPlayerWidget Ui;
