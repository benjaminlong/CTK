...
public:
  ...
  /// Set the directory with all the translation files.
  /// The QComboBox automatically add the language to the items.
...
signals:
  ...
  /// It's also possible to listen the signal "currentChanged(int)" and
  /// then recover the currentLanguage.
