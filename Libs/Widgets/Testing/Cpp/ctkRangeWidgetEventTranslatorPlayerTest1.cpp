...
void checkFinalWidgetState(void* data)
  ...
  CTKCOMPARE(widget->maximumValue(), 69.00);
  CTKCOMPARE(widget->minimumValue(), 32.00);
  }
//-----------------------------------------------------------------------------
...
int ctkRangeWidgetEventTranslatorPlayerTest1(int argc, char * argv [] )
{
  ...
  // Test case 1
  ctkRangeWidget* widget = new ctkRangeWidget() << vvSetName("RangeWidget1");
  etpWidget.addTestCase(widget,
                        xmlDirectory + "ctkRangeWidgetEventTranslatorPlayerTest1.xml",
                        &checkFinalWidgetState);

  // Test case 2
  ctkRangeWidget* widget2 = new ctkRangeWidget() << vvSetName("RangeWidget2");
