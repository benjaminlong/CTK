...
int ctkDoubleRangeSliderEventTranslatorPlayerTest1(int argc, char * argv [])
{
  ...
  // Test case 1
  ctkDoubleRangeSlider* widget = new ctkDoubleRangeSlider() << vvSetName("doubleRangeSlider1");
  etpWidget.addTestCase(widget,
                        xmlDirectory + "ctkDoubleRangeSliderEventTranslatorPlayerTest1.xml",
                        &checkFinalWidgetState);

  // Test case 2
  ctkDoubleRangeSlider* widget2 = new ctkDoubleRangeSlider() << vvSetName("doubleRangeSlider2");
