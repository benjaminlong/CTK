...
int ctkPathLineEditEventTranslatorPlayerTest1(int argc, char * argv [] )
{
  ...
  ctkPathLineEdit* button = new ctkPathLineEdit("Files",
                                                ...
                                                ctkPathLineEdit::Files, widget) << vvSetName("PathLineEdit1");
  ...
  ctkPathLineEdit* button2 = new ctkPathLineEdit("Dirs", QStringList("CTK*"), ctkPathLineEdit::AllEntries, widget2) << vvSetName("PathLineEdit2");
